...
module.exports = {
  // ====================
  // Função de Migração para Criar Inquilino Padrão
  // ====================
  ...
  down: (queryInterface: QueryInterface) => {
    return queryInterface.bulkDelete("Tenants", {}); // Remove todos os inquilinos da tabela Tenants
  }
};
