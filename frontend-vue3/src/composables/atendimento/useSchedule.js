...
import { ListarAgendamentos, CriarAgendamento, AtualizarAgendamento, DeletarAgendamento } from 'src/service/schedules'
...
export function useSchedule() {
  ...
  const criarAgendamento = async (agendamento) => {
    loading.value = true
    try {
      const { data } = await CriarAgendamento(agendamento)
  ...
  const atualizarAgendamento = async (agendamento) => {
    loading.value = true
    try {
      const { data } = await AtualizarAgendamento(agendamento.id, agendamento)
