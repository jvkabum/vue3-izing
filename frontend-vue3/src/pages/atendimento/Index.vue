...
import { useAtendimentoState } from '@/composables/atendimento/useAtendimentoState'
import { useAtendimentoDrawers } from '@/composables/atendimento/useAtendimentoDrawers'
...
const { activeTab, visibleTabs, handleTabChange } = useAtendimentoTabs()
const { 
  loadTickets,
  loadMoreTickets,
  handleTicketSelect,
