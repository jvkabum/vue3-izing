    ...
    <q-item>
      ...
      <q-item-section>
        ...
        <q-item-label v-if="item.status == 'DISCONNECTED'">
          ...
          >
            Certifique-se de que seu celular esteja conectado à internet e tente
            novamente, ou solicite um novo QR Code
          </span>
          <span
            class="row col"
        ...
        <q-item-label v-if="['PAIRING', 'TIMEOUT'].includes(item.status)">
          ...
          <span class="row col">
            Certifique-se de que seu celular esteja conectado à internet e o WhatsApp esteja
            aberto, ou clique no botão 'Desconectar' para obter um novo QR Code
          </span>
        </q-item-label>
