<template>
  ...
  >
    ...
    <ContatoModal
      ...
      @update:modalContato="modalContato = $event"
...
const {
  ...
  localizarContato: searchContact,
...
const localizarContato = (search, update, abort) => {
  searchContact(search, update, abort)
}
</script>
